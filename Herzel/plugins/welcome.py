...
from Herzel import app,BOT_ID,OWNER_ID,LOG_GROUP_ID
from Herzel.mongo.gban import GBan
from Herzel.mongo.usersdb import adds_served_user
from Herzel.mongo.welcomedb import Greetings
from Herzel.utils.custom_filters import admin_filter, command
...
from Herzel.utils.filter_groups import cleanner,welcomes,leftwelcome
...
my news channel @Theherzelbot.

**New to Me, Touch the below button and start me in PM**
                    """,
                    reply_markup=InlineKeyboardMarkup(
            [
                InlineKeyboardButton("quick start guide", url="http://t.me/herzelbot?start=help"),
            ]))
