...
from Herzel.mongo.reportdb import Reporting
...
Herzel will then reply with a message stating that admins have been notified. 
...
or when used to report an admin. Herzel assumes that admins 
