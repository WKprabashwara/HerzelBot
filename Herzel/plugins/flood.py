...
from Herzel.mongo.flooddb import is_flood_on,flood_off,flood_on
from Herzel.utils.filter_groups import flood_group
...
Anti-Function is the inbuilt toolkit in Herzel for avoid spammers, and to improve Anti-Function of your group"""
__helpbtns__ = (
        [[
            InlineKeyboardButton
                (
