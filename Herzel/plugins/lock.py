...
from Herzel.mongo.locksdb import (
    b_on,
    b_off,
    is_b_on,
    remove_chat,
)
from Herzel import app, app as pbot, MONGO_URL as  MONGO_DB_URI,LOG_GROUP_ID
from Herzel.utils.custom_filters import admin_filter
from button import Locks
from Herzel.core.decorators.permissions import current_chat_permissions,member_permissions


#====== Mongo database =========
client = pymongo.MongoClient(MONGO_DB_URI)
dbd = client["herzelbot"]
db = dbd
lockdb = db.lockdb1
#================================
