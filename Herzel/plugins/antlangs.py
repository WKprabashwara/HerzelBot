...
# re-write for @herzelbot by szsupunma
#====================================================================================================

from pyrogram import filters
from pyrogram.types import Message
from re import search
from Herzel import app as NEXAUB
from Herzel.utils.custom_filters import admin_filter
from Herzel import app
from Herzel.mongo.antilang import (
    set_anti_func,
    del_anti_func,
    get_anti_func
)
...
from Herzel.utils.filter_groups import antifunc_group
...
- Herzel can mute members who are not subscribed your channel until they subscribe
